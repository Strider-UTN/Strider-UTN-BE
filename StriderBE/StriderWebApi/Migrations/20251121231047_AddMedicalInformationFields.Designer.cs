...
namespace StriderWebApi.Migrations
{
    ...
    [Migration("20251121231047_AddMedicalInformationFields")]
    partial class AddMedicalInformationFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.AthleteInjury", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<DateTime?>("RecoveryEstimateDate")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.ToTable("AthleteInjuries", (string)null);
                });
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.CompletedWorkout", b =>
                {
                    ...
                    b.HasIndex("TrainingSessionAthleteId");
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.TrainingInterval", b =>
                {
                    ...
                    b.HasIndex("TrainingSeriesId", "OrderIndex");
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.TrainingSeries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("RecoveryBetweenSets")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(10)
                        .HasColumnType("character varying(10)")
                    ...
                    b.ToTable("TrainingSeries", null, t =>
                        {
                            t.HasCheckConstraint("CK_TrainingSeries_SingleParent", "((\"TrainingSessionId\" IS NULL AND \"TrainingTemplateId\" IS NOT NULL) OR (\"TrainingSessionId\" IS NOT NULL AND \"TrainingTemplateId\" IS NULL))");
                        });
                });
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.WorkoutInjury", b =>
                {
                    ...
                    b.Property<bool>("AffectedPerformance")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
                    ...
                    b.ToTable("WorkoutInjuries", null, t =>
                        {
                            t.HasCheckConstraint("CK_WorkoutInjury_Severity", "\"Severity\" >= 1 AND \"Severity\" <= 10");
                        });
                });
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.WorkoutLap", b =>
                {
                    ...
                    b.HasIndex("CompletedWorkoutId", "Index");

                    b.ToTable("WorkoutLaps", (string)null);
                });

            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.WorkoutSensations", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("WorkoutSensations", null, t =>
                        {
                            t.HasCheckConstraint("CK_WorkoutSensations_Effort", "\"Effort\" >= 1 AND \"Effort\" <= 10");

                            t.HasCheckConstraint("CK_WorkoutSensations_Fatigue", "\"Fatigue\" >= 1 AND \"Fatigue\" <= 10");

                            t.HasCheckConstraint("CK_WorkoutSensations_Motivation", "\"Motivation\" >= 1 AND \"Motivation\" <= 10");

                            t.HasCheckConstraint("CK_WorkoutSensations_MuscularLoad", "\"MuscularLoad\" >= 1 AND \"MuscularLoad\" <= 10");

                            t.HasCheckConstraint("CK_WorkoutSensations_OverallFeeling", "\"OverallFeeling\" >= 1 AND \"OverallFeeling\" <= 10");
                        });
                });
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.Athlete", b =>
                {
                    ...
                    b.Property<DateTime?>("MedicalClearanceExpiryDate")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.CompletedWorkout", b =>
                {
                    b.HasOne("StriderWebApi.Domain.DomainClasses.TrainingSessionAthlete", "TrainingSessionAthlete")
                        .WithMany("CompletedWorkouts")
                        .HasForeignKey("TrainingSessionAthleteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.TrainingInterval", b =>
                {
                    b.HasOne("StriderWebApi.Domain.DomainClasses.TrainingSeries", "TrainingSeries")
                        .WithMany("Intervals")
            ...
            modelBuilder.Entity("StriderWebApi.Domain.DomainClasses.WorkoutSensations", b =>
                {
                    b.HasOne("StriderWebApi.Domain.DomainClasses.CompletedWorkout", "CompletedWorkout")
                        .WithOne("Sensations")
                        .HasForeignKey("StriderWebApi.Domain.DomainClasses.WorkoutSensations", "CompletedWorkoutId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
