...
namespace StriderWebApi.Data.Repositories.Interfaces
{
    public interface ITrainingSessionsRepository
    {
        ...
        Task<IEnumerable<TrainingSession>> GetByMesocycleIdAsync(int mesocycleId, CancellationToken cancellationToken = default);
        ...
        Task<IEnumerable<TrainingSession>> GetByAthleteIdAsync(int athleteId, int? planningId = null, DateTime? startDate = null, DateTime? endDate = null, CancellationToken cancellationToken = default);
